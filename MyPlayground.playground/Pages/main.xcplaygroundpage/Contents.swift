...
func ConCoun(continent : String, countries : Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

ConCoun(continent : "Antarctica", countries : 0)
 ...
 */
// write your code here
func Bottles(count: Int, contents: String, wall: String) {
    print("\(count) bottles of \(contents) on the \(wall) wall.")
}

Bottles(count: 99, contents: "beer", wall: "frickin'")
